...
class ImageData:
    ...
    def map_dicom_contour(self, dicoms_path, contours_path, link_path):
            ...
            if os.path.isdir(img_path) and os.path.isdir(label_path):  # patient's dicom and contour folder both exist
                ...
                for img_file in img_file_list:
                    ...
                    if os.path.isfile(contour_file):
                        self.dicomn_contour_pairs.append((patient_id, img_file, contour_file))
                    else:
                        self.logger.info(
        ...
        self.logger.info('Found {} matching dicom and i-contour pairs.'.format(str(len(self.dicomn_contour_pairs))))
